    ...
    class Copper {
        ...
        private function createContact() {
            ...
            $contact_json = array(
                ...
                "custom_fields" => [
                    array(
                        "custom_field_definition_id" => 610084,
                        "value" => $this->contact_data['callAt'],
                    ),
                    array(
                        "custom_field_definition_id" => 610085,
                        "value" => $this->changePhoneNumber(),
                    ),
                    array(
                        "custom_field_definition_id" => 610086,
                        "value" => $this->contact_data['contactMethod'],
                    ),
                    array(
                        "custom_field_definition_id" => 620748,
                        "value" => $this->addNotes(),
                    ),
                    array(
                        "custom_field_definition_id" => 584671,
