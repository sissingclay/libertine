...
define("AGILE_DOMAIN", "libertine");  # Example : define("domain","jim");
define("AGILE_USER_EMAIL", "sharon@libertineconsultants.co.za");
define("AGILE_REST_API_KEY", "3pvkvos1skr9ockkg1ikr2to5j");
